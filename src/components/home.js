        ...
        <div className="relative h-[calc(100vh-8rem)] md:h-[calc(90vh-5rem)] overflow-hidden rounded-2xl md:rounded-3xl bg-[#f6f6fb] dark:bg-[#332d4a] border border-[#e1e3ec] dark:border-[#2f2948] shadow-md flex flex-col">
            ...
            <div className="absolute inset-0 bg-[url('/handshake-line.svg')] bg-center bg-contain bg-no-repeat opacity-20 dark:opacity-10 pointer-events-none" />
                ...
                <div className="relative flex flex-col h-full flex-1">
                    ...
                    {/* ===== BARRA DE ENVÍO DE MENSAJES FIJA ===== */}
                    {info_canal && (
                        <div className="flex-shrink-0 px-3 pb-3 md:px-6 md:pb-6 lg:px-10 lg:pb-8 pt-2 md:pt-3 border-t border-[#e1e3ec]/30 dark:border-[#2f2948]/30 bg-[#f6f6fb]/80 dark:bg-[#332d4a]/80 backdrop-blur-sm">
                            <div className="relative flex items-center gap-2 md:gap-3 bg-[#e7e7f2] dark:bg-[#4a4168] border border-[#d3d2de] dark:border-[#312b48] rounded-full px-3 py-2 md:px-6 md:py-4 shadow-inner h-12 md:h-14">
